     ...
     <div class="box-content">
                <form role="form" action="<%=basePath%>/user/message/save" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="角色">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">描述</label>
                        <input type="text" name="description" class="form-control" id="exampleInputPassword1" placeholder="描述">
                    </div>
                    
                    <div class="form-group">
                        <label for="exampleInputPassword1">分组ID</label>
                        <input type="text" name="groupid" class="form-control" id="exampleInputPassword1" placeholder="分组ID">
                    </div>
                    
                    <div class="form-group">
                        <label for="exampleInputFile">上次头像</label>
