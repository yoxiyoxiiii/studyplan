...
<div class="ch-container">
    <div class="row">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<%= basePath%>/user/message">个人中心</a>
            </li>
             <li>
                <a href="#">设置个人信息</a>
            </li>
    ...
    <div class="box-inner">
     ...
     <div class="box-content">
                <form role="form" action="<%=basePath%>/user/message/save" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">学号</label>
                        <input type="text" name="studyNumber" class="form-control" id="exampleInputEmail1" placeholder="学号">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">真实姓名</label>
                        <input type="text" name="realName" class="form-control" id="exampleInputPassword1" placeholder="真实姓名">
                    </div>
                    
                     <div class="form-group">
                        <label for="exampleInputPassword1">学校全称</label>
                        <input type="text" name="groupid" class="form-control" id="exampleInputPassword1" placeholder="学校">
                    </div>
                    
                    <div class="form-group">
                        <label for="exampleInputPassword1">学院全称</label>
                        <input type="text" name="groupid" class="form-control" id="exampleInputPassword1" placeholder="学院信息">
                    </div>
