...
<div class="ch-container">
    ...
    <div class="box-inner">
     ...
     <div class="box-content">
          ...
          <form action="<%=basePath %>/course/doUpload" method="post" enctype="multipart/form-data" class="dropzone">
					...
					<div class="form-group">				
						<div class="control-group">
		                    ...
		                    <div class="controls">
		                        <select  name="typeId" id="selectError2" data-rel="chosen">
		                            <optgroup label="课程分类">
		                            		<option value="0" selected="selected">文本资料</option>
		                            		<option value="1">视频资料</option>
		                            </optgroup>
		                        </select>
		                    </div>
		                </div>
