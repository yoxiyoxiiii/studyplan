...
<div class="ch-container">
    ...
    <div class="box-inner">
     ...
     <div class="box-content">
                <form role="form" action="<%=basePath%>/course/update" method="post">
	                 <div class="control-group">
		                    <label for="selectError2">课程分类</label>
		                    <div class="controls">
		                        <select  name="kindsId" id="selectError2" data-rel="chosen">
		                            <optgroup label="课程分类">
		                            		<option selected="selected">${kinds.name}</option>
		                            </optgroup>
		                        </select>
		                    </div>
		                </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="${course.name}" class="form-control" id="exampleInputEmail1" placeholder="菜单名">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">开始时间</label>(2017-03-02:14:00)
                        <input type="text" name="startTime" value="${course.startTime}" class="form-control" id="exampleInputPassword1" placeholder="URL">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">结束时间</label>(2017-03-02:15:00)
                        <input type="text" name="endTime" value="${course.endTime}" class="form-control" id="exampleInputPassword1" placeholder="URL">
                    </div>
                    
                     <div class="form-group">
                        <label for="exampleInputPassword1">课时数</label>(讲)
                        <input type="text" name="url" class="form-control" placeholder="课时数">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">单节时长</label>(min)
                        <input type="text" name="perTime" value="45"class="form-control" placeholder="单节时长">
                    </div>
                    
                     <div class="form-group">
                       <textarea name="description" placeholder="课程简介" class="autogrow">${course.description}</textarea>
                    </div>
