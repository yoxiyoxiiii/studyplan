...
<div class="ch-container">
    ...
    <div class="box-inner">
     ...
     <div class="box-content">
                <form role="form" action="<%=basePath%>/course/save" method="post">
	                 <div class="control-group">
	                    ...
	                    <div class="controls">
	                        <select  name="kindsId" id="selectError2" data-rel="chosen">
	                            ...
	                            <optgroup label="课程分类">
	                            	<c:forEach items="${allKinds}" var="c">
	                                <option value="${c.id}" class="${c.icon}">${c.name}</option>
	                                </c:forEach>
	                            </optgroup>
	                        </select>
	                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                       <textarea name="description" placeholder="课程简介" class="autogrow"></textarea>
                    </div>
