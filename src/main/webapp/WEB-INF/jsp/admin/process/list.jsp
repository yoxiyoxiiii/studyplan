...
<div class="ch-container">
    ...
    <tr>
        ...
        <th>课程介绍</th>
        <th>操作 
        <a href="<%= basePath%>/course/add" ><i class="btn btn-success glyphicon glyphicon-plus"><span>添加</span></i></a>
        </th>
    ...
    <c:forEach items="${beans}" var="c">
	    <tr>
	        ...
	        <td class="center">${c.endTime}</td>
	        <td class="center">${c.perTime}</td>
	        <td class="center"> 
	        
	         <textarea name="description" placeholder="课程简介" class="autogrow">${c.description}</textarea>
	          
	        </td>
	        <td class="center">
	            <a class="btn btn-info" href="<%= basePath%>/course/edit?id=${c.id}">
	                <i class="glyphicon glyphicon-edit icon-white"></i>
	                编辑
	            </a>
	            <a class="btn btn-danger" href="<%= basePath%>/course/delete/${c.id}">
	                <i class="glyphicon glyphicon-trash icon-white"></i>
	                删除
	            </a>
	            <div class="btn-group">
                    <a class="btn btn-primary" href="<%= basePath%>/course/upload?id=${c.id}"><i class="glyphicon glyphicon-upload"></i>资料上传</a>
                </div>
                
                 <div class="btn-group">
                    <a class="btn btn-primary" href="<%= basePath%>/course/fileList?id=${c.id}"><i class="glyphicon glyphicon-tasks"></i>资料列表</a>
                </div>
