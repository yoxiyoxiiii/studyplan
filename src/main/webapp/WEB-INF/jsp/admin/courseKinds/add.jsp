...
<head>
    ...
    <!-- 文件上传 -->
    <link href="<%= basePath%>/static/css/dropzone.css" rel="stylesheet" />
...
<div class="ch-container">
    ...
    <div class="box-inner">
     ...
     <div class="box-content">
                <form role="form" action="<%=basePath%>/kinds/save" method="post">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                       <textarea name="description" placeholder="简介" class="autogrow"></textarea>
                    </div>
