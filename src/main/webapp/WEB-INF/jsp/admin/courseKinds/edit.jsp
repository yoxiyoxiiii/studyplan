...
<div class="ch-container">
    ...
    <div class="box-inner">
     ...
     <div class="box-content">
                <form role="form" action="<%=basePath%>/kinds/update" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">分类</label>
                        <input type="text" name="name" value="${courseKinds.name}" class="form-control" id="exampleInputEmail1" placeholder="菜单名">
                    </div>
                    <div class="form-group">
                        <textarea name="description" placeholder="介绍" class="autogrow">${courseKinds.description}</textarea>
                    </div>
                     <div class="form-group">
                        <label for="exampleInputEmail1">图标</label>
                        <div class="control-group">
			                    <div class="controls">
			                        <select id="selectError1" name="icon" class="form-control" data-rel="chosen">
			                        	<option value="${courseKinds.icon}" selected="selected" class="${courseKinds.icon}">${courseKinds.icon}</option>
			                            <option value="glyphicon glyphicon-book" class="glyphicon glyphicon-book">glyphicon-book</option>
			                            <option value="glyphicon glyphicon-road" class="glyphicon glyphicon-road">glyphicon-road</option>
			                            <option value="glyphicon glyphicon-eye-open" class="glyphicon glyphicon-eye-open">glyphicon-eye-open</option>
			                            <option value="glyphicon glyphicon-camera" class="glyphicon glyphicon-camera">glyphicon-camera</option>
			                            <option value="glyphicon glyphicon-map-marker" class="glyphicon glyphicon-map-marker">glyphicon-map-marker</option>
			                            <option value="glyphicon glyphicon-leaf" class="glyphicon glyphicon-leaf">glyphicon-leaf</option>
			                            <option value="glyphicon glyphicon-plane" class="glyphicon glyphicon-plane">glyphicon-plane</option>
			                            <option value="glyphicon glyphicon-align-left" class="glyphicon glyphicon-align-left">glyphicon-align-left</option>
			                            <option value="glyphicon glyphicon-headphones" class="glyphicon glyphicon-headphones">glyphicon-headphones</option>
			                            <option value="glyphicon glyphicon-file" class="glyphicon glyphicon-file">glyphicon-file</option>
			                            <option value="glyphicon glyphicon-th" class="glyphicon glyphicon-th">glyphicon-th</option>
			                            <option value="glyphicon glyphicon-bell" class="glyphicon glyphicon-bell">glyphicon-flag</option>
			                            <option value="glyphicon glyphicon-film" class="glyphicon glyphicon-film">glyphicon-film</option>
			                            <option value="glyphicon glyphicon-search" class="glyphicon glyphicon-search">glyphicon-search</option>
			                            <option value="glyphicon glyphicon-star" class="glyphicon glyphicon-star">glyphicon-star</option>
			                            <option value="glyphicon glyphicon-user" class="glyphicon glyphicon-user">glyphicon-user</option>
			                            <option value="glyphicon glyphicon-screenshot" class="glyphicon glyphicon-screenshot">glyphicon-screenshot</option>
			                        </select>
			                    </div>
               			 </div>
                    </div>
                    ...
                    <input type="text" name="id" value="${courseKinds.id}" hidden="hidden"/>
