...
<div class="ch-container">
    ...
    <tr>
        ...
        <th>介绍</th>
        <th>操作 
        <a href="<%= basePath%>/kinds/add" ><i class="btn btn-success glyphicon glyphicon-plus"><span>添加</span></i></a>
        </th>
    ...
    <c:forEach items="${pages}" var="c">
	    <tr>
	        ...
	        <td class="center"> 
	         <textarea name="description" placeholder="介绍" class="autogrow">${c.description}</textarea>
	        </td>
	        <td class="center">
	            <a class="btn btn-info" href="<%= basePath%>/kinds/edit?id=${c.id}">
	                <i class="glyphicon glyphicon-edit icon-white"></i>
	                编辑
	            </a>
	            <a class="btn btn-danger" href="<%= basePath%>/kinds/delete/${c.id}">
