...
<div class="ch-container">
    ...
    <tr>
        ...
        <th>分组ID</th>
        <th>操作 
        <a href="<%= basePath%>/role/add" ><i class="btn btn-success glyphicon glyphicon-plus"><span>添加</span></i></a>
        </th>
    ...
    <c:forEach items="${page}" var="p">
	    <tr>
	        ...
	        <td class="center">
	            <span class="label-success label label-default">${p.groupid}</span>
	        </td>
	        <td class="center">
	            <a class="btn btn-info" href="<%= basePath%>/role/edit?id=${p.id}">
	                <i class="glyphicon glyphicon-edit icon-white"></i>
	                编辑
	            </a>
	            <a class="btn btn-danger" href="<%= basePath%>/role/delete/${p.id}">
