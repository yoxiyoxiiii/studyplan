...
<div class="ch-container">
    ...
    <div class="box-inner">
     ...
     <div class="box-content">
                <form role="form" action="<%=basePath%>role/update" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">角色</label>
                        <input type="text" name="name" value="${role.name}" class="form-control" id="exampleInputEmail1" placeholder="角色">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">描述</label>
                        <input type="text" name="description" value="${role.description}" class="form-control" id="exampleInputPassword1" placeholder="描述">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">分组ID</label>
                        <input type="text" name="groupid" value="${role.groupid}" class="form-control" id="exampleInputPassword1" placeholder="分组ID">
                    </div>
                    
                    <input type="text" name="id" value="${role.id}" hidden="hidden"/>
