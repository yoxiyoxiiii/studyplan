...
<div class="ch-container">
    ...
    <tr>
        ...
        <th>菜单等级</th>
        <th>操作 
        <a href="<%= basePath%>/menu/add" ><i class="btn btn-success glyphicon glyphicon-plus"><span>添加</span></i></a>
        </th>
	        ...
	        <td class="center">${c.url}</td>
	     	...
	     	<c:choose>
	     		<c:when test="${c.level==1}">
	       		 ...
	       		 <c:otherwise>
	        		<td class="center">${c.parent.name}</td>
	       		 </c:otherwise>
	        </c:choose>
	        
	        <td class="center">
	            <span class="label-success label label-default">${c.level}</span>
	        </td>
	        <td class="center">
	            <a class="btn btn-info" href="<%= basePath%>/menu/edit?id=${c.id}">
	                <i class="glyphicon glyphicon-edit icon-white"></i>
	                编辑
	            </a>
	            <a class="btn btn-danger" href="<%= basePath%>/menu/delete/${c.id}">
