...
<div class="ch-container">
    ...
    <div class="box-inner">
     ...
     <div class="box-content">
                <form role="form" action="<%=basePath%>/menu/save" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">菜单名</label>
                        <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="菜单名">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="control-group">
			                    <div class="controls">
			                        <select id="selectError1" name="upid" class="form-control" data-rel="chosen">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1">菜单等级</label>
                         <div class="control-group">
			                    <div class="controls">
			                        <select id="selectError1" name="level" class="form-control" data-rel="chosen">
